              ...
              <li key={event.id}>
                ...
                >
                  <div className="flex items-baseline gap-2">
                    <span
                      className={`w-3 shrink-0 text-center text-[0.75rem] ${
                        event.status === 'failed'
                          ? 'text-danger'
                          : event.status === 'warn'
                            ? 'text-warn'
                    ...
                    <span className="min-w-0 flex-1">
                      ...
                      <span className="mt-0.5 block text-[0.6875rem] uppercase tracking-wide text-muted">
                        {event.stage_label}
                ...
                {isOpen && details.length > 0 && (
                  <dl className="mb-1 ml-7 rounded-md bg-canvas px-2.5 py-2 text-[0.75rem] text-muted">
                    {details.map((line) => (
